...
from registration.views import (
    ...
    dashboard_journey_lookup,
    dashboard_journey_lookup_search,
    dashboard_event_builder,
    dashboard_abstract_center,
    dashboard_participant_center,
    dashboard_participant_lookup,
    dashboard_membership_center,
    dashboard_payment_center,
    dashboard_corporate_center,
    dashboard_registration_kit_center,
    registration_qr_checkin,
    dashboard_certificate_center,
    dashboard_chest_card_center,
    dashboard_food_token_center,
    dashboard_event_media_center,
    dashboard_presentation_center,
    dashboard_bulk_email_center,
    dashboard_bulk_sms_center,
    dashboard_sms_template_center,
    dashboard_speaker_outreach_center,
...
urlpatterns = [
    ...
    path('dashboard/journey-lookup/', dashboard_journey_lookup, name='dashboard_journey_lookup'),
    path('dashboard/journey-lookup/search/', dashboard_journey_lookup_search, name='dashboard_journey_lookup_search'),
    path('dashboard/event-builder/', dashboard_event_builder, name='dashboard_event_builder'),
    path('dashboard/abstract-center/', dashboard_abstract_center, name='dashboard_abstract_center'),
    path('dashboard/participant-center/', dashboard_participant_center, name='dashboard_participant_center'),
    ...
    path('dashboard/food-token-center/', dashboard_food_token_center, name='dashboard_food_token_center'),
    ...
    path('dashboard/sms-template-center/', dashboard_sms_template_center, name='dashboard_sms_template_center'),
    path('dashboard/speaker-outreach-center/', dashboard_speaker_outreach_center, name='dashboard_speaker_outreach_center'),
