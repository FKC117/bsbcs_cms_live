...
SMS_MASKING_CHAR_LIMIT = config('SMS_MASKING_CHAR_LIMIT', default=100, cast=int)
SMS_NON_MASKING_CHAR_LIMIT = config('SMS_NON_MASKING_CHAR_LIMIT', default=100, cast=int)
